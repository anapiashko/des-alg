...
public class DESImpl implements DES {
     ...
     */
    private String decrypt(String key, String plaintext) {
    ...
    private String encryptBlock(String plaintextBlock) throws Exception {
    ...
    public String encryption(String key, String message) {
        String result;

        //encryption
        result = encrypt(key, utfToBin(message));
    ...
    public String decryption(String key, String message) {
        ...
        //dencryption
        result = decrypt(key, hexToBin(message));
        result = binToUTF(result);
        System.out.println(result);
        return result;
    }
}
